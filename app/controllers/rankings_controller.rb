class RankingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @ranking.update(ranking_params)
        ...
        format.json { render action: 'show', status: :ok, location: @ranking }
      else
  ...
  private
    ...
    def ranking_params
      params.require(:ranking).permit(:stance_id, :category, :useful_ranking, :useful_justification, :trustworthy_ranking, :trustworthy_justification, :accurate_ranking, :accurate_justification, :interesting_ranking, :interesting_justification)
    end
end
